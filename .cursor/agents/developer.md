...
workflow branch and parent-approved base. Stop on missing base, duplicate
artifacts, wrong-base PRs, or scan failures; deliberate splits require explicit
parent approval.
