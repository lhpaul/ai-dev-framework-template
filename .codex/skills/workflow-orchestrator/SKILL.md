...
2. Read `docs/ai/development-workflow/protocols/89-batch-orchestrate-work-protocol.md`.
...
4. Treat the protocol as canonical. Use `workflow-item-orchestrator` for each selected item when your runner supports skill-to-skill handoff; otherwise continue in the current session by following `90-orchestrate-work-protocol.md` item by item.
