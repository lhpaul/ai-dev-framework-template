...
6. Resolve and report the artifact repository owner before reviewing. Specs are hub-owned in `workflow_hub` mode unless a future protocol explicitly changes that.
