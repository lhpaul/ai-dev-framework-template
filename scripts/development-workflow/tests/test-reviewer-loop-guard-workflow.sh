...
run_test "summary_head_binding_present" "yes" "$(contains 'grep -Fq "\"head_sha\": \"${HEAD_SHA}\""')"
...
run_test "dispatch_redispatches_on_head_move_during_summary_dispatch" "yes" "$(contains "Redispatching regression for the current head.")"
