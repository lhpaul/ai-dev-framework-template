...
run_test "summary_comment_payload_survives_comment_fetch_failure" "yes" "$(contains "Failed to fetch PR comments, but triggering comment has summary markers; counting event payload.")"
