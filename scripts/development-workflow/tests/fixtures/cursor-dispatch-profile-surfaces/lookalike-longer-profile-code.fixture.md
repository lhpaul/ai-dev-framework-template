Declare a profile per `docs/workflow/development-workflow/integrations/cursor-dispatch-profiles.md`: `cursor-native-handoffs`, `cursor-parent-orchestrated`, or `cursor-inline-fallback`.
