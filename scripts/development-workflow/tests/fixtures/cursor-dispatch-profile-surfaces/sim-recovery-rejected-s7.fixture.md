...
- S9 -> R9
- S10 -> R10
- S10b -> subcase (no matrix row; harness/local-path denial, #1746, is not a named stop condition)
- S11 -> R11
- S12 -> R12
- S13 -> R13
- S14 -> R14
...
S7 (mid-run native to parent orchestrated) re-declaration is rejected as a coarse-fact mismatch, the same as any other profile/fact disagreement.
