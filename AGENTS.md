...
| Advance One Item (alias)         | `/run-item-work` command (or `item-orchestrator` agent)           | `/run-item-work`                                              | `/run-item-work` alias or `workflow-item-orchestrator` skill                         | Follow `docs/workflow/development-workflow/protocols/91-orchestrate-work-protocol.md`                                                                                             |
...
| Orchestrate Work (primary)       | `/run-work` command (or `orchestrator` agent)                     | `/run-work`                                                   | `/run-work` alias or `workflow-orchestrator` skill                                   | Follow `docs/workflow/development-workflow/protocols/90-batch-orchestrate-work-protocol.md` (no-target / explicit-list), `91` (single-item), `95` (epic) — see Protocol 96 for routing spec |
