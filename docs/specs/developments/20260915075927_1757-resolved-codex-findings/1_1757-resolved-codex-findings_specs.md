...
| `codex_current_verdict_unrecognized` | Unrecognized Codex verdict | The current terminal verdict matches neither an approved clean template nor recognizable finding markers |
