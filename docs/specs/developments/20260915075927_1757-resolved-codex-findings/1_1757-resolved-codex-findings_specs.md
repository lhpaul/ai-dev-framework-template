...
that names the live head to authorize readiness; when no such trigger exists,
the first marker-pinned clean root comment for that head may be canonical.
