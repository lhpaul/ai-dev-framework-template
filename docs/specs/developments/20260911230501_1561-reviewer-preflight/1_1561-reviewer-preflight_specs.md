...
| ----------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| Prerequisite not met    | The base branch this item targets, its set of lifecycle stages, or the pull-request state for any one of those stages, is empty, unresolved, or malformed | Nothing is dispatched. No per-platform verdict is computed. The run resolves the failed input and re-runs |
