...
| Whether a later plan revision changed the population an evidence record covers | Comparing the record's stated population against the current revision | A record that still reproduces exactly can be stale against a population the plan no longer describes |
