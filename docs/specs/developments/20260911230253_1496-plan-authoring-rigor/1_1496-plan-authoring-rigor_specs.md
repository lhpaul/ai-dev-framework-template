...
- **Evidence in the plan document**: the sampling records, or, under Rule 1's escape hatch, enumeration records, count derivations, existence searches, and consumer enumerations the firing rules require, each naming the revision it was gathered at, and the scope statements Rule 6 requires, each naming the governed scope and discharge point. This is what survives merge and reaches the implementer.
