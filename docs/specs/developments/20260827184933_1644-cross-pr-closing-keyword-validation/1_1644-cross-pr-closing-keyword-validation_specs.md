...
| Tests for parser and validator edge cases | ACs 5-12 and 18-34 — ACs 5-9 and 11 cover parity with what each closer excludes, including the divergent handling of title fence state; ACs 18-24 the ownership rule with its contested, no-signal, team-prefixed, platform-link, documentation-stage and closed-sibling cases; ACs 25-29 the sibling-lifecycle, title, retarget and readiness triggers; ACs 30-31 the indeterminate outcome; ACs 32-33 the superseded-run ordering rule; AC 12 the fork-origin exclusion and AC 34 idempotence |
