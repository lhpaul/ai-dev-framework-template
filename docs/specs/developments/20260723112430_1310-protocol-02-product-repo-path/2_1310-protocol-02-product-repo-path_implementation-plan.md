...
| Sync cross-reference gate | `rg -n '^### Post-apply path verification ' .claude/commands/sync-template.md` plus semantic-block inspection | The anchored section blocks or requires explicit acknowledgement for genuinely unresolved required paths |
