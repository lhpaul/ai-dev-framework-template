...
- **No concrete multi-layer signal, external-system result is no signal found, and either no high call-site volume or an explicit human override for high call-site volume is recorded** → the item may proceed as Fast Track.
