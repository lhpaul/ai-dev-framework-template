...
1. Search `docs/workflow/development-workflow/protocols/91-orchestrate-work-protocol.md` for any change outside the Step 3 worktree isolation block (e.g., Step 7a, Step 8, Protocol 90 references, `post-merge-cleanup.sh`, `pr-review-loop.sh`).
